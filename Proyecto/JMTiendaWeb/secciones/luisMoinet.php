            ...
            <div class="row">
                <div class="embed-responsive embed-responsive-16by9  col-sm-12 col-12 p-0 m-0"> 
                    <video width="100%" height="240px" loop autoplay muted>
                        <source src="images/louisVideo.mp4" type="video/mp4" alt="video de muestra">
                    </video>
                </div> 
            </div>
        </div>
   ...
   <!-- BARRA QUE NOS DICE DONDE ESTAMOS -->
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="luisMoinet.php" class="text-dark">Louis Moinet</a></li>
        </ol>
    </nav>
    ...
    <div class="container-fluid  pt-4">
        ...
        <?php
            ...
            $resultados = file_get_contents("http://localhost:50532/api/Productos?mc=Luis+Moinet");
        ...
        <div class="col-sm-6 col-md-4 col-12 border shadow p-3 mb-5 bg-white rounded m-2 hatch">
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    ...
                    <!--Botón favorito-->
                      <a href="../inicioSesion.php"><button type="button" class="btn btn-primary" data-container="body" style="background-color:black; border:none;" data-toggle="popover" data-placement="bottom" data-content="">
                          <i class="far fa-heart"></i>
                      </button></a>

                    <!--Botón comprar-->
                    <a href="../inicioSesion.php"><button type="button" class="btn btn-success" data-container="body" data-toggle="popover" data-placement="bottom" data-content="">
                          Comprar
                      </button></a>
                  </div>
                </div>
