...
<body>
        ...
        <div class="row">
            <div class="embed-responsive embed-responsive-16by9  col-sm-12 col-12 p-0 m-0"> 
                <video width="100%" height="240px" loop autoplay muted>
                    <source src="images/seikoVideo.mp4" type="video/mp4" alt="video de muestra">
                </video>
            </div> 
        </div>
    </div>
   ...
   <!-- BARRA QUE NOS DICE DONDE ESTAMOS -->
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="seiko.php" class="text-dark">Seiko</a></li>
        </ol>
    </nav>
  ...
  <div class="container-fluid  pt-4">
        ...
        <?php
            ...
            $resultados = file_get_contents("http://localhost:50532/api/Productos?mc=Seiko");
