...
<body>
     ...
     <?php include("nav.php");?>
            ...
            <div class="row">
                <div class="embed-responsive embed-responsive-16by9  col-sm-12 col-12 p-0 m-0"> 
                    <video width="100%" height="240px" loop autoplay muted>
                        <source src="images/rolexVideo.mp4" type="video/mp4" alt="video de muestra">
                    </video>
                </div> 
            </div>
        </div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="rolex.php" class="text-dark">Rolex</a></li>
            </ol>
        </nav>
  ...
  <div class="container-fluid  pt-4">
        ...
        <?php
            ...
            $resultados = file_get_contents("http://localhost:50532/api/Productos?mc=Rolex");
