                ...
                <div class="card-img-overlay">
                    ...
                    <center>
                        <FORM ACTION="control.php" METHOD="POST" style="color:white; margin-top:5%;">
                            <div>
                                <input type="email" class="form-control col-sm-4" name="nombre" aria-describedby="emailHelp" placeholder="Pon tu nombre">
                            </div><br>
                            <div>
                                <input type="email" class="form-control col-sm-4" name="nombre" aria-describedby="emailHelp" placeholder="Pon tu correo (obligatorio)">
                            </div><br>
                            <div>
                                <input type="password" class="form-control col-sm-4" name="pass" aria-describedby="emailHelp" placeholder="Pon tu contraseña (obligatorio)">
                            </div><br>
                                <input type="submit" value="Registrarme" style="margin-top:3%; margin-bottom:5%; border:0px; background-color:#28A645; color:white;"><br>
