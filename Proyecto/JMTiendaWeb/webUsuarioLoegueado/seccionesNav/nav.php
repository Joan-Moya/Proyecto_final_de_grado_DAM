        ...
        <div class="row border-bottom">
            ...
            <nav class="nav offset-4 offset-sm-5">
                ...
                <button type="button" class="btn btn-default"  style="color:white;">
                    <a href="carrito.php" style="color:white;"> <i class="fas fa-shopping-cart"></i></a><!--Icono del botón--> 
                </button>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="metodosPago.php">Método de pago</a></li>
                        <li><a href="misDirecciones.php">Direcciones</a></li>
                        <li class="divider"></li>
