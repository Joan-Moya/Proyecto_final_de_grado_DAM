...
<body>
    ...
    <p class="text-center pt-5 pb-5"><h1 class="text-center pt-5 pb-5" style="font-size:60px"><b>Favoritos</b></h1></p>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#" class="text-dark">Favoritos</a></li>
        </ol>
    </nav>
      ...
      <div class="container-fluid  pt-4">
        ...
        <div class="col-sm-6 col-md-4 col-12 border shadow p-3 mb-5 bg-white rounded m-2 hatch">
                <div class="thumbnail">
                  <img src="../productImages/<?php$ImagenProducto;?>" class="p-3 img-fluid" alt="foto reloj" style="height:250px;">
                  <div class="caption">
                    <h3><?php echo $Marca." ".$Modelo;?></h3>
                    <p><b>Id del pedido:</b><?php echo $PedidoId;?></p><br>
                    <p><b>Fecha de compra:</b><?php echo $FechaCreacion;?></p><br>
                    <p><b>Estado del pedido:</b><?php echo $Estado;?></p><br>
